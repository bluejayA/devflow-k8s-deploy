...
| **3. 파일 생성** | Dockerfile + Dockerfile.dockerignore (root) + manifests/{deployment.yaml \| statefulset.yaml, service.yaml, serviceaccount.yaml, networkpolicy.yaml(클러스터 설정 시)} (서브디렉토리) |
