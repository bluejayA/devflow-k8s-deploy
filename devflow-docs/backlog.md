...
_Last updated: 2026-04-29 — BL-020/021/022 머지 완료 (PR #35 + #36)_

---

## Next

BL-001(Go 스택) 완료. BL-019(entrypoint 검증 일원화)는 Codex round 2 후속이라 같은 도메인 정리 차원에서 우선 검토 가치 있음.
...
| **BL-017** | Go 프레임워크 probe 자동 감지 — gin/echo/fiber | [#27](https://github.com/bluejayA/devflow-k8s-deploy/issues/27) | 스택 확장 (BL-001 후속) |
