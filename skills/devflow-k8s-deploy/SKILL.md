...
description: |
  Use when a user requests Dockerfile or Kubernetes manifest generation for a JVM project.
  JVM(Kotlin + Java Spring) 백엔드 프로젝트를 분석하여 Dockerfile + k8s manifest를 자동 생성합니다.
